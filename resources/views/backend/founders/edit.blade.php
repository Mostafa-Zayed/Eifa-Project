            ...
            <div class="card card-statistics h-100">
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <form action="{{route('founders.update',$founder['id'])}}" method="POST" style="width:90%;">
                            @csrf
                            @method('PUT')
                            <div class="row">
                                <div class="col-sm-6">
                                    <label for="name_ar" class="mr-sm-2">{{ucwords(trans('founders.name_ar'))}} :</label>
                                    <input id="name_ar" type="text" name="name[ar]" class="form-control" value="{{$founder['name']['ar']}}">
                                    @error('name.ar')
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <input type="text" class="form-control" name="name[en]" value="{{$founder['name']['en']}}">
                                    @error('name.en')
                                    <span class="alert-danger">{{$message}}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    ...
                                    <textarea class="form-control" name="description[ar]" id="description_ar" rows="3">{{$founder['description']['ar']}}</textarea>
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    ...
                                    <textarea class="form-control" name="description[en]" id="description_en" rows="3">{{$founder['description']['en']}}</textarea>
                            ...
                            <div class="row">
                                <div class="col">
                                    ...
                                    <input type="url" class="form-control" name="facebook" value="{{$founder['facebook']}}">
                                    @error('facebook')
                                    <span class="alert-danger">{{$message}}</span>
                                    @enderror
                                </div>
